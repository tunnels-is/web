  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="text-gradient">Routable DNS</span>
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-dark-text-secondary mb-8">
            With Security and Daily Threat List Updates
          </h2>
          <p className="text-xl text-dark-text-secondary max-w-3xl mx-auto leading-relaxed">
            Tunnels offers a built-in DNS Server/Proxy which comes with extensive blacklisting features,
            daily block list updates and the ability to define custom DNS records. Tunnels DNS server
            also facilitates DNS Routing to ensure proper DNS resolution when connected to multiple networks.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            DNS Protection Available For Free
          </h2>
          <p className="text-xl text-dark-text-secondary mb-8 max-w-2xl mx-auto">
            Get started with Tunnels DNS protection today. No account or payment needed for basic DNS features.
          </p>
          <motion.a
            href="/download"
