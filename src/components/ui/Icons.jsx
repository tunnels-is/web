...
export const LockShieldIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 8L12 18V30C12 42.5 20.5 54 32 56C43.5 54 52 42.5 52 30V18L32 8Z"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="#3b82f6" fillOpacity="0.25"/>
    <rect x="26" y="26" width="12" height="14" rx="2"
          stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.35"/>
...
export const NetworkGlobeIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="22" stroke="#06b6d4" strokeWidth="2.5" fill="#06b6d4" fillOpacity="0.2"/>
    <ellipse cx="32" cy="32" rx="10" ry="22" stroke="#06b6d4" strokeWidth="2.5"/>
...
export const ShieldCheckIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 8L12 18V30C12 42.5 20.5 54 32 56C43.5 54 52 42.5 52 30V18L32 8Z"
          stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="#10b981" fillOpacity="0.25"/>
...
export const BoltIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M36 10L18 36H32L28 54L46 28H32L36 10Z"
          stroke="#fbbf24" strokeWidth="2.5" strokeLinejoin="round" fill="#fbbf24" fillOpacity="0.35"/>
  </svg>
);
...
export const DevicesIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="44" y="12" width="14" height="24" rx="2"
          stroke="#8b5cf6" strokeWidth="2.5" fill="#8b5cf6" fillOpacity="0.3"/>
    <path d="M48 36H54" stroke="#8b5cf6" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);

export const CoinsIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="26" cy="26" r="14" stroke="#fbbf24" strokeWidth="2.5" fill="#fbbf24" fillOpacity="0.3"/>
    <circle cx="38" cy="38" r="14" stroke="#fbbf24" strokeWidth="2.5" fill="#fbbf24" fillOpacity="0.35"/>
    <path d="M26 20V32M20 26H32" stroke="#fbbf24" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
...
export const VideoIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="16" width="48" height="32" rx="3"
          stroke="#ec4899" strokeWidth="2.5" fill="#ec4899" fillOpacity="0.25"/>
    <path d="M26 26L38 32L26 38V26Z"
          stroke="#ec4899" strokeWidth="2" strokeLinejoin="round" fill="#ec4899" fillOpacity="0.4"/>
  </svg>
);
...
export const HomeAutomationIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 32L32 14L54 32V52C54 53.1 53.1 54 52 54H12C10.9 54 10 53.1 10 52V32Z"
          stroke="#f59e0b" strokeWidth="2.5" strokeLinejoin="round" fill="#f59e0b" fillOpacity="0.25"/>
    <circle cx="32" cy="36" r="6" stroke="#f59e0b" strokeWidth="2.5" fill="#f59e0b" fillOpacity="0.35"/>
...
export const DatabaseIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="32" cy="18" rx="20" ry="8" stroke="#06b6d4" strokeWidth="2.5" fill="#06b6d4" fillOpacity="0.3"/>
...
export const BlockIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="22" stroke="#ef4444" strokeWidth="2.5" fill="#ef4444" fillOpacity="0.25"/>
    <path d="M14 14L50 50" stroke="#ef4444" strokeWidth="3" strokeLinecap="round"/>
  </svg>
);
...
export const GamepadIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 24C10 24 6 28 6 34C6 40 10 44 16 44H20C22 44 24 42 24 40V28C24 26 22 24 20 24H16Z"
          stroke="#8b5cf6" strokeWidth="2.5" fill="#8b5cf6" fillOpacity="0.2"/>
    ...
    <rect x="24" y="22" width="16" height="20" rx="2"
          stroke="#8b5cf6" strokeWidth="2.5" fill="#8b5cf6" fillOpacity="0.25"/>
    <circle cx="46" cy="32" r="2" fill="#8b5cf6"/>
    <circle cx="52" cy="36" r="2" fill="#8b5cf6"/>
  </svg>
);
...
export const DocumentIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 8H38L48 18V54C48 55.1 47.1 56 46 56H16C14.9 56 14 55.1 14 54V10C14 8.9 14.9 8 16 8Z"
          stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.2"/>
    <path d="M38 8V18H48" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M22 30H42M22 38H42M22 46H34" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const SyncIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14 42C14 42 19 54 32 54C45 54 54 45 54 32"
          stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
    <path d="M50 22V12M50 22H40" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M14 42V52M14 42H24" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const KeyIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20" cy="44" r="12" stroke="#fbbf24" strokeWidth="2.5" fill="#fbbf24" fillOpacity="0.25"/>
    <path d="M28 36L50 14M50 14V22M50 14H42"
          stroke="#fbbf24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="20" cy="44" r="4" fill="#fbbf24" fillOpacity="0.4"/>
  </svg>
);
...
export const RaspberryPiIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="14" y="14" width="36" height="36" rx="2"
          stroke="#10b981" strokeWidth="2.5" fill="#10b981" fillOpacity="0.15"/>
    <circle cx="24" cy="24" r="3" fill="#10b981" fillOpacity="0.5"/>
    <circle cx="40" cy="24" r="3" fill="#10b981" fillOpacity="0.5"/>
    <circle cx="24" cy="40" r="3" fill="#10b981" fillOpacity="0.5"/>
    <circle cx="40" cy="40" r="3" fill="#10b981" fillOpacity="0.5"/>
    <rect x="28" y="28" width="8" height="8" rx="1"
          stroke="#10b981" strokeWidth="2" fill="#10b981" fillOpacity="0.3"/>
  </svg>
);
...
export const ServerIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="12" y="14" width="40" height="12" rx="2"
          stroke="#64748b" strokeWidth="2.5" fill="#64748b" fillOpacity="0.2"/>
    <rect x="12" y="32" width="40" height="12" rx="2"
          stroke="#64748b" strokeWidth="2.5" fill="#64748b" fillOpacity="0.25"/>
    <rect x="12" y="50" width="40" height="12" rx="2"
          stroke="#64748b" strokeWidth="2.5" fill="#64748b" fillOpacity="0.2"/>
    <circle cx="20" cy="20" r="2" fill="#64748b"/>
    <circle cx="20" cy="38" r="2" fill="#64748b"/>
    <circle cx="20" cy="56" r="2" fill="#64748b"/>
  </svg>
);
...
export const ContainerIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="12" y="16" width="40" height="32" rx="2"
          stroke="#06b6d4" strokeWidth="2.5" fill="#06b6d4" fillOpacity="0.2"/>
    <path d="M22 16V48M32 16V48M42 16V48" stroke="#06b6d4" strokeWidth="2" strokeLinecap="round"/>
    <path d="M12 28H52M12 38H52" stroke="#06b6d4" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const BookIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14 12H22C26 12 30 14 32 16C34 14 38 12 42 12H50V46H42C38 46 34 48 32 50C30 48 26 46 22 46H14V12Z"
          stroke="#f59e0b" strokeWidth="2.5" strokeLinejoin="round" fill="#f59e0b" fillOpacity="0.2"/>
    <path d="M32 16V50" stroke="#f59e0b" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
...
export const BuildingIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="12" y="18" width="40" height="38"
          stroke="#64748b" strokeWidth="2.5" fill="#64748b" fillOpacity="0.2"/>
    <path d="M12 56H52M26 56V44H38V56" stroke="#64748b" strokeWidth="2.5" strokeLinecap="round"/>
    <rect x="20" y="26" width="6" height="6" fill="#64748b" fillOpacity="0.4"/>
    <rect x="38" y="26" width="6" height="6" fill="#64748b" fillOpacity="0.4"/>
    <rect x="29" y="26" width="6" height="6" fill="#64748b" fillOpacity="0.4"/>
  </svg>
);
...
export const LayersIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 14L10 26L32 38L54 26L32 14Z"
          stroke="#8b5cf6" strokeWidth="2.5" strokeLinejoin="round" fill="#8b5cf6" fillOpacity="0.25"/>
...
export const LightbulbIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 10C22 10 14 18 14 28C14 34 17 39 22 42V46C22 48.2 23.8 50 26 50H38C40.2 50 42 48.2 42 46V42C47 39 50 34 50 28C50 18 42 10 32 10Z"
          stroke="#fbbf24" strokeWidth="2.5" fill="#fbbf24" fillOpacity="0.3"/>
...
export const QuestionIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="22" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.2"/>
...
export const EyeShieldIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 22C20 22 12 32 12 32C12 32 20 42 32 42C44 42 52 32 52 32C52 32 44 22 32 22Z"
          stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <circle cx="32" cy="32" r="6" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.2"/>
    <path d="M14 14L50 50" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);
...
export const SearchIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="28" cy="28" r="16" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M40 40L54 54" stroke="#3b82f6" strokeWidth="3" strokeLinecap="round"/>
  </svg>
);
...
export const PlaneIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M54 14L10 32L22 36L26 50L32 38L46 42L54 14Z"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinejoin="round" fill="#3b82f6" fillOpacity="0.15"/>
    <path d="M26 50L32 38L46 42" stroke="#3b82f6" strokeWidth="2.5" strokeLinejoin="round"/>
  </svg>
);
...
export const BriefcaseIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M22 22V18C22 15.8 23.8 14 26 14H38C40.2 14 42 15.8 42 18V22"
          stroke="#3b82f6" strokeWidth="2.5"/>
    <path d="M8 32H56" stroke="#3b82f6" strokeWidth="2.5"/>
  </svg>
);
...
export const UsersIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="24" cy="22" r="8" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M8 50C8 42 14 36 24 36C34 36 40 42 40 50"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
    <circle cx="44" cy="20" r="6" stroke="#3b82f6" strokeWidth="2" fill="#3b82f6" fillOpacity="0.15"/>
...
export const RocketIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32 10C32 10 46 14 50 28C54 42 50 50 50 50L38 54L26 54L14 50C14 50 10 42 14 28C18 14 32 10 32 10Z"
          stroke="#8b5cf6" strokeWidth="2.5" fill="#8b5cf6" fillOpacity="0.3"/>
    <circle cx="32" cy="28" r="4" fill="#8b5cf6" fillOpacity="0.5"/>
...
export const MonitorIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="12" width="48" height="32" rx="2"
          stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M22 44V50H42V44" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M16 50H48" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
...
export const GlobeIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="24" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.05"/>
    <path d="M32 8C32 8 22 18 22 32C22 46 32 56 32 56M32 8C32 8 42 18 42 32C42 46 32 56 32 56"
          stroke="#3b82f6" strokeWidth="2.5"/>
    <path d="M8 32H56" stroke="#3b82f6" strokeWidth="2.5"/>
    <path d="M12 20H52M12 44H52" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const ChartIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="42" cy="20" r="3" fill="#3b82f6"/>
    <circle cx="54" cy="28" r="3" fill="#3b82f6"/>
    <path d="M8 54H56" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const TargetIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="22" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.05"/>
    <circle cx="32" cy="32" r="14" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <circle cx="32" cy="32" r="6" fill="#3b82f6" fillOpacity="0.3"/>
...
export const LinkIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M28 36L36 28" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
...
export const WrenchIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 14C50 14 45 15 42 18L24 36L28 40L46 22C49 19 50 14 50 14Z"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinejoin="round" fill="#3b82f6" fillOpacity="0.1"/>
    <circle cx="18" cy="46" r="8" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.15"/>
    <path d="M46 14L50 18" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const ClockIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="32" cy="32" r="22" stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M32 18V32L42 38" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const ChatIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 14H52C54.2 14 56 15.8 56 18V38C56 40.2 54.2 42 52 42H20L12 50V14C12 14 12 14 12 14Z"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinejoin="round" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M22 26H42M22 32H34" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const BirdIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M48 16C48 16 40 18 36 22C32 18 20 16 12 24C12 24 16 28 20 28C20 28 18 36 24 40C24 40 28 48 40 48C52 48 54 38 54 32C54 26 52 22 52 22L48 16Z"
          stroke="#3b82f6" strokeWidth="2.5" strokeLinejoin="round" fill="#3b82f6" fillOpacity="0.1"/>
    <circle cx="40" cy="26" r="2" fill="#3b82f6"/>
  </svg>
);
...
export const PhoneIcon = ({ className = "w-full h-full" }) => (
  <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="20" y="8" width="24" height="48" rx="3"
          stroke="#3b82f6" strokeWidth="2.5" fill="#3b82f6" fillOpacity="0.1"/>
    <path d="M28 50H36" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
    <rect x="24" y="14" width="16" height="28" rx="1" fill="#3b82f6" fillOpacity="0.1"/>
  </svg>
);
